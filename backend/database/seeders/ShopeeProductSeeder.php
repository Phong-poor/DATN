    ...
    public function run()
    {
        $products = [
            [
                ...
                'name' => 'Laptop Gaming Acer Predator Helios Neo 16 PHN16 71 53M7 (NH.QLUSV.004)',
                'price' => 31990000,
                'discount' => 2000000,
                'image' => 'https://cdn.tgdd.vn/Products/Images/44/309192/acer-predator-helios-neo-16-phn16-71-53m7-i5-nhqlusv004-thumb-600x600.jpg',
                'desc' => "★ Shopee Mall Chính Hãng ★\nLaptop Gaming Quốc Dân Acer Predator Helios Neo 16 trang bị Intel Core i5-13500HX, RTX 4050 6GB cực mạnh mẽ.\n- Màn hình 16 inch WUXGA 165Hz sRGB 100% cực nét.\n- Tản nhiệt kim loại lỏng mát mẻ, đèn nền RGB 4 vùng cực ngầu.\n- RAM 16GB DDR5, SSD 512GB siêu tốc.\n- Tặng kèm Balo Predator chính hãng.\nBảo hành VIP 3S1 - 1 đổi 1 trong 3 ngày.",
                'variants' => ['16GB - 512GB']
            ],
            [
                'brand' => 'ASUS',
        ...
        foreach ($products as $p) {
            // Danh muc
            $dm = DanhMuc::firstOrCreate(['ten_danhmuc' => $p['category']], ['trangthai' => 1]);
            
            // Thuong hieu
            $th = ThuongHieu::firstOrCreate(['ten_thuonghieu' => $p['brand']]);
