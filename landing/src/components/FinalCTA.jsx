...
export default function FinalCTA() {
  ...
  return (
    <section className="landing-section relative py-28 bg-gradient-to-b from-[#020817] via-[#071120] to-[#020817] overflow-hidden border-t border-slate-900">
        ...
        <div className="bg-slate-950/80 border border-cyan-500/25 rounded-3xl p-8 sm:p-16 text-center backdrop-blur-md glow-cyan relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h2 className="font-['Space_Grotesk'] text-4xl sm:text-6xl font-extrabold text-white mb-6 tracking-tight leading-[1.1]">
              Xây dựng <br/>
              <span className="gradient-text bg-gradient-to-r from-cyan-400 via-blue-400 to-white">bộ máy mơ ước của bạn</span>
            </h2>

            {/* Description */}
            <p className="text-slate-300 text-base sm:text-lg font-light leading-relaxed max-w-xl mx-auto mb-10">
              Mỗi bộ máy được lắp ráp và kiểm thử kỹ lưỡng để đáp ứng nhu cầu học tập, làm việc, gaming và sáng tạo nội dung.
            </p>
