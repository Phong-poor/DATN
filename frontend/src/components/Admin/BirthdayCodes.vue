            ...
            <div class="config-card">
              ...
              <div class="form-layout">
                ...
                <div class="form-group">
                  ...
                  <p class="form-help-text">Bạn có thể cấu hình thêm các mã giảm giá sinh nhật mới tại mục <router-link to="/admin/promotions" class="inline-link">Khuyến mãi</router-link>.</p>
                </div>
              </div>
            </div>
