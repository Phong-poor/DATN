            ...
            <div class="container hero-grid">
                <div class="hero-text-block reveal-el">
                    ...
                    <div class="hero-ctas">
                        ...
                        <router-link to="/products" class="btn-glass-neon">
                            ...
                            <div class="rec-card" v-for="p in recommendedProducts" :key="p.key_id">
                                ...
                                <div class="rec-body">
                                    ...
                                    <div class="rec-actions">
                                        <router-link :to="`/products/${p.id}?variant=${p.key_id}`" class="btn-rec-detail">
                                            Xem chi tiết
                                        </router-link>
            ...
            <div class="container">
                ...
                <div class="matrix-grid">
                    ...
                    <div class="matrix-card">
                        ...
                        <router-link to="/products?cat=3" class="btn-matrix-go">Xem các mẫu Pro →</router-link>
                    </div>
                    ...
                    <div class="matrix-card primary-card">
                        ...
                        <router-link to="/products?cat=2" class="btn-matrix-go beast-btn">Chinh Phục Ngay →</router-link>
                    </div>
                    ...
                    <div class="matrix-card">
                        ...
                        <router-link to="/products?cat=7" class="btn-matrix-go">Xem các mẫu Scholar →</router-link>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="deal-box">
                    <div class="deal-grid">
                        ...
                        <div class="deal-timer-area text-center">
                            ...
                            <router-link to="/products" class="btn-claim-deal">
                                Nhận Ưu Đãi Ngay →
                            </router-link>
        ...
        <section class="cta-sec reveal-el">
            <div class="container text-center">
                <div class="cta-content-box">
                    ...
                    <div class="cta-btns">
                        <router-link to="/products" class="btn-cta-primary">Mua Laptop Elite Ngay</router-link>
                        <router-link to="/contact" class="btn-cta-secondary">Liên hệ nhận tư vấn</router-link>
                    </div>
                </div>
            </div>
        </section>
