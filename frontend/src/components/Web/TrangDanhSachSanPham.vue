...
import Header from '../Layout/DauTrang.vue'
import Footer from '../Layout/ChanTrang.vue'
        ...
        <div class="container">
            ...
            <main class="content">
                ...
                <div v-if="products.length === 0 && route.query.q" class="empty-search">
                    ...
                    <button @click="router.push('/san-pham')" class="clear-search-btn">Xem tất cả sản phẩm</button>
                </div>
                ...
                <div class="grid" v-else-if="displayedProducts.length > 0">
                    <div class="card" v-for="p in displayedProducts" :key="p.key_id">
                        ...
                        <div class="img-box" @click="router.push(`/san-pham/${p.id}?variant=${p.key_id}`)">
                            <img :src="p.img" :alt="p.name" />
                        </div>

                        <div class="card-body">
                            <h3 @click="router.push(`/san-pham/${p.id}?variant=${p.key_id}`)">{{ p.fullName }}</h3>
                            ...
                            <div class="card-actions">
                                <router-link :to="`/san-pham/${p.id}?variant=${p.key_id}`" class="btn-detail">
                                    Chi tiết
                                </router-link>
